...
<body>
    ...
    <hr>
    <h1>Internal Assessment 1</h1>
    <div>
        <div id="form">
        <form method="GET" action="iat1_insert.jsp">
            ...
            <input type="number" id="co1" placeholder="CO1" name="co1" size="30" min="0" max="30" required><br>
            <label for="co2">CO2 Marks</label><br>
            <input type="number" id="co2" placeholder="CO2" name="co2" size="30" min="0" max="20" required><br>
            <input type="submit" value="Save" name="submit">   <input type="reset" value="Reset" name="reset">
        </form>
        ...
        <table>
            ...
            String sql="select * from iat1 ORDER by regno";
            ...
            %>
                <tr>
                    ...
                    <td><a href="iat1_update.jsp?id=<%=id1%>">Edit</a></td>
                </tr>
            <%
            i++;
            }
            ...
            <tr>
                <td colspan="3"align="right"><b>CO Attainment IAT1<b></td>
                <td><b><%=co1att%></b></td>
                <td><b><%=co2att%></b></td>
            </tr>
        </table>
    ...
    String sql1="update final set iat1='"+co1att+"' where co='co1'";
    String sql2="update final set iat1='"+co2att+"' where co='co2'";
