...
<body>
    ...
    <div id="form">
        <form method="POST" action="#">
            ...
            java.sql.Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/"+db,"root","");
            Statement st= con.createStatement();
            String sql="select * from iat2 where id="+id;
            ...
            <input type="number" id="co3" placeholder="CO3" name="co3" size="30" min="0" max="30" value="<%=rs.getString("co3")%>" required><br>
            <label for="co4">CO4 Marks</label><br>
            <input type="number" id="co4" placeholder="CO4" name="co4" size="30" min="0" max="20" value="<%=rs.getString("co4")%>" required><br>
            <%
            }
            %>
            <input type="submit" value="Update" name="submit">   <input type="reset" value="Reset" name="reset">
            </form>
            <center id="main"><a href="iat2.jsp">Back To IAT2</a></center>
    </div>
</body>
</html>
