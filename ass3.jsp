...
<body>
    ...
    <div>
        <div id="form">
        <form method="GET" action="ass3_insert.jsp">
            ...
            <input type="number" id="co5" placeholder="CO5" name="co5" size="30" min="0" max="20" required><br>
            <label for="co6">CO6 Marks</label><br>
            <input type="number" id="co6" placeholder="CO6" name="co6" size="30" min="0" max="30" required><br>
        ...
        <table>
            ...
            String sql="select * from ass3 ORDER by regno";
            ...
            %>
                <tr>
                    ...
                    <td><a href="ass3_update.jsp?id=<%=id1%>">Edit</a></td>
                </tr>
            <%
            i++;
            }
            ...
            <tr>
                <td colspan="3"align="right"><b>CO Attainment Assignment3<b></td>
                <td><b><%=co5att%></b></td>
                <td><b><%=co6att%></b></td>
            </tr>
        </table>
    ...
    String sql1="update final set ass3='"+co5att+"' where co='co5'";
    String sql2="update final set ass3='"+co6att+"' where co='co6'";
