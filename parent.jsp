...
<body>
    <center>
        ...
        <div class="sub">PARENT NAME : <%= parent  %></div>
        <div class="sub">STUDENT : <%= name  %></div>
    ...
    <hr>
        ...
        <form method="POST" action="saveparent.jsp">
         <input type="hidden" value="<%=name%>" readonly name="name"><br>
         <input type="hidden" value="<%=parent%>" readonly name="parent"><br>
        ...
        String sql="select * from survey where type='parent'";
