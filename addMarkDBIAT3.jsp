...
<%
    ...
    try
    {
        ...
        {  
            ...
            if( row.getCell(4)==null||row.getCell(4).toString().isEmpty()==true)                       ico5 = 0;
            else                                            ico5 = Float.parseFloat(row.getCell(4).toString());

            
            if( row.getCell(5)==null||row.getCell(5).toString().isEmpty()==true)                       aco5 = 0;
            else                                            aco5 = Float.parseFloat(row.getCell(5).toString());
        ...
        response.sendRedirect("iat3.jsp");
    }
    catch(Exception e)
    {
        out.println(e);
