...
<body>
    ...
    <hr>
    <h1>Internal Assessment 2</h1>
    <div>
        <div id="form">
        <form method="GET" action="iat2_insert.jsp">
            ...
            <input type="number" id="co3" placeholder="CO3" name="co3" size="30" min="0" max="30" required><br>
            <label for="co4">CO4 Marks</label><br>
            <input type="number" id="co4" placeholder="CO4" name="co4" size="30" min="0" max="20" required><br>
        ...
        <table>
            ...
            String sql="select * from iat2 ORDER by regno";
            ...
            %>
                <tr>
                    ...
                    <td><a href="iat2_update.jsp?id=<%=id1%>">Edit</a></td>
                </tr>
            <%
            i++;
            }
            ...
            <tr>
                <td colspan="3"><b>CO Attainment IAT2<b></td>
                <td><b><%=co3att%></b></td>
                <td><b><%=co4att%></b></td>
            </tr>
        </table>
    ...
    String sql1="update final set iat2='"+co3att+"' where co='co3'";
    String sql2="update final set iat2='"+co4att+"' where co='co4'";
